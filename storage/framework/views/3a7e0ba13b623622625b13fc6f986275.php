...
<form action="<?php echo e(url('/sale-invoice')); ?>" method="post" id="add-saleinvoice-form">
    ...
    <div class="container-fluid">
      <div class="row d-flex justify-content-end align-items-center">
        ...
        <div class="col-8 d-flex justify-content-end">
          <a href="<?php echo e(url('/sale-invoice')); ?>" class="btn btn-light mr-2">Cancel</a>
          <button type="submit"  name="" class="btn btn-light mr-2">Save & New</button>
          <button  name="" value="" class="btn btn-primary">Save & Preview</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid">
    <?php echo csrf_field(); ?>
    <div class="main-form-container  mt-4 mb-4">
      <div class="row mx-0">
        <div class="col-6">
          <div class="row">
            <div class="col text-right">
              <a href="#" class="btn btn-link px-0 pt-3 pb-3" data-toggle="modal" data-target="#customerModal">Add New Customer</a>
            </div>
          </div>
          <div class="customer-information-invoice">
            ...
            <div class="row mt-2">
              ...
              <div class="col-sm-9 customer-address-label"></div>
              <input type="hidden" name="address"  class="address" readonly="true">
            </div>
            <div class="row mt-2">
              <div class="col-sm-3">Phone</div>
              <div class="col-sm-9 customer-phone-label"></div>
              <input type="hidden" name="phone"  class="phone" readonly="true">
            </div>
            ...
            <div class="form-group PlaceofSupply d-none">
              ...
              <select class="form-control" id="PlaceofSupply" name="PlaceofSupply" required >
                ...
                <option value="<?php echo e($state->id); ?>"><?php echo e($state->name); ?> (<?php echo e($state->state_code); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            ...
            <div class="row mt-2">
              ...
              <div class="col-sm-9 customer-pan-label"></div>
              <input type="hidden" name="customer_pan"  class="customer_pan" readonly="true">
            </div>
            <?php endif; ?>
            <div class="row mt-2">
              <div class="col-sm-3">GSTIN</div>
              <div class="col-sm-9 customer-gstin-label"></div>
              <input type="hidden" name="customer_gstno"  class="customer_gstno" readonly="true">
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="controls mt-2">
                  <label><input type="checkbox" name="is_same_shipping" value="1" id="is_same_shipping_invoice"> Use
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="" class="control-label ">Shipping Name</label>
                    <div class="controls ">
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls ">
                      <textarea name="shippingAddress" id="shippingAddress" rows="3" cols="2"
                        placeholder="Enter Shipping Address" maxlength="500" class="form-control shippingAddress"></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="" class="control-label ">Shipping Phone</label>
                    <div class="controls ">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="" class="control-label ">Shipping State</label>
                    <div class="controls ">
                      <select type="list" data-value="" name="shippingState" class="form-control shippingState" id="shippingState">
                        <option value="">Select State</option>
                        <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($state->id); ?>"><?php echo e($state->name); ?> (<?php echo e($state->state_code); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="" class="control-label ">Shipping Country</label>
                    <div class="controls">
                      <input type="text" name="shippingCountry" id="shippingCountry" class="form-control shippingCountry" placeholder="Enter Country">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="" class="control-label ">Shipping GSTIN</label>
                    <div class="controls ">
                      <input type="text" value="" name="shippingGSTIN" id="shippingGSTIN" placeholder="Enter Shipping GSTIN" class="form-control shippingGSTIN" maxlength="30">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="" class="control-label ">Shipping PAN</label>
                    <div class="controls ">
                      <input type="text" value="" name="shippingpan" id="shippingPAN" placeholder="Enter Shipping PAN shippingpan" class="form-control" maxlength="30">
                    </div>
                  </div>
                </div>
        ...
        <div class="col-6 pb-5" >
          <div class="row mt-2">
                ...
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      <?php
                          if ($invoicenumber) {
                                $newInvoiceId = $invoicenumber->id + 1;
                            } else {
                                $newInvoiceId = 1;
                            }
                      ?> 
                      <input id="invoice_id" name="invoice_number" class="form-control" value="<?php echo e($newInvoiceId); ?>">
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      <input name="challan_date" type="text"  class="form-control datepicker">
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      <input name="challan_number" type="text"  class="form-control challan_number">
                    </div>
                  </div>
                </div>
              ...
              <?php if($invoice_option->po_no == 1): ?>
                ...
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      <input name="lrno"  type="text" class="form-control">
                    </div>
                  </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      <input name="eway"  class="form-control">
                    </div>
                  </div>
                </div>
                <?php endif; ?>
            ...
            <div class="col-sm-12 text-right"><a href="" class="btn btn-link px-0 pt-3 pb-3" data-toggle="modal"
            ...
            <input type="hidden" name="transport_transport_id" class="transport_transport_id">
            <input type="hidden" name="transport_id" class="transport_id">
            <input type="hidden" name="transport_vehicle_no" class="transport_vehicle_no">
                ...
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-6">
                      <input name="transport_id_label" value="" disabled id="transport_id_label" class="form-control transport_id_label">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      <input name="vehicle_no_label" value="" id="vehicle_no_label" class="form-control vehicle_no_label">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <tr class="product-item-row">
                ...
                <td colspan="5">
                  ...
                  <input class="hidden-item-product-is_transport" name="hidden_item_product_is_transport[]"
                    type="hidden" value="0">
                  <input class="hidden-item-product-gst" name="hidden_item_product_gst[]" type="hidden" value="">
                ...
                <td class="discount_field">
                  <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="discount[]" class="form-control disc" style="width:60px" value="0" maxlength="10">
                  </div>
                  <div class="input-group mt-2 flex-nowrap">
                    <div class="input-group-prepend">
                      <div class="input-group-text">Rs</div>
                    </div>
                    <input type="text" name="discount_rupee[]" style="width:60px" class="form-control disc_in_rupee"  value="0"
                    maxlength="10">
                  </div>
                ...
                <td class="gst_field">
                  <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="gst[]" class="form-control gst"  value="0" style="width:60px" maxlength="10">
                  </div>
                  <div class="input-group mt-2 flex-nowrap">
                    <div class="input-group-prepend">
                      <div class="input-group-text">Rs</div>
                    </div>
                    <input type="text" style="width:60px" name="total_gst_rate[]" class="form-control gst_amount"  value="0"
                    maxlength="10">
                  </div>
                  <input type="hidden" name="gst_amount[]" class="gst_amount" value="0">
                  <input type="hidden" name="sell_price_with_tax[]" class="sell_price_with_tax" value="0">

                  <input type="hidden" name="igst_rate[]" class="igst_rate" value="0">
                </td>
                ...
                <td>
                  <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="cess[]"style="width:60px" class="form-control cess" placeholder="%" >
                  </div>
                  <div class="input-group mt-2 flex-nowrap">
                    <div class="input-group-prepend">
                      <div class="input-group-text">Rs</div>
                    </div>
                    <input type="text" name="cess_amount[]" style="width:60px" class="form-control cess_amount" placeholder="Rs" value="0">
                  </div>
                ...
                <td style="width:90px;">
                  <center>
                    <input type="text" name="total[]" class="form-control line_total" placeholder="Total"
                      style="width:80px;">
                  </center>
                </td>
                ...
                <td>
                  <center>
                    <button type="button" value="" class="btn btn-remove-row btn-lg"><i
            ...
            <tfoot>
              <tr class="">
                ...
                <td>
                    ...
                    <label type="text" name="" id="total_price_lable" class="total_taxable_label">0</label>
                </td>
                ...
                <td>
                    <input type="hidden" name="total_gst_rate" id="total_gst_rate" value="0">
                    <label type="text" name="" id="total_gst_rate_label" class="">0</label>
                </td>
      ...
      <div class="row mx-0 mt-4 bg-white">
        <div class="col-sm-6 border-right py-3">
          ...
          <input type="hidden" name="" class="customer_state_id" value="">
          <input type="hidden" name="" class="currentUser_stateId" value="<?php echo e($organization->state_id); ?>">
        ...
        <div class="col-sm-6 py-3">
          <div class="row mt-2">
            ...
            <div class="col-sm-5 text-right total_taxable_label" >0.00</div>
          </div>

          <div class="cgst">
            <div class="row mt-2 ">
              <div class="col-sm-7"> CGST </div>
              <input type="hidden" name="total_tax" id="total_tax" value="0">
              <div class="col-sm-5 text-right total_cgst_tax_lable">0.00</div>
            </div>
  
            
            <div class="row mt-2">
              <div class="col-sm-7">SGST </div>
              <input type="hidden" name="total_tax" id="total_tax" value="0">
              <div class="col-sm-5 text-right total_sgst_tax_lable">0.00</div>
            </div>
          ...
          <div class="igst d-none">
            <div class="row mt-2">
              <div class="col-sm-7">IGST </div>
              <input type="hidden" name="total_tax" id="total_tax" value="0">
              <div class="col-sm-5 text-right total_tax_lable">0.00</div>
            </div>
          ...
          <div class="row mt-2">
            <div class="col-sm-7">Total Tax </div>
            <input type="hidden" name="total_tax" id="total_tax" value="0">
            <div class="col-sm-5 text-right total_tax_lable">0.00</div>
          </div>
          ...
          <div class="row mt-2">
            ...
            <div class="col-sm-7 d-flex justify-content-end"><input type="text" class="form-control w-50" id="other_charges" name="other_charges" /></div>
          </div>
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control total_discount_in_percentage" name="total_discount_in_percentage"  placeholder="00">
                  </div>
                </div>
                <div class="col-sm-8">
                  <div class="input-group mb-2">
                    ...
                    <input type="text" class="form-control total_discount_in_amount" name="total_discount_in_amount"  placeholder="00">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row mt-2 mb-3 payment-type">
            <div class="col-4">
                <p>Payment Type <span class="text-danger">*</span></p>
            </div>
            <div class="col-8">
                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                    <input type="radio" class="btn-check" name="btnradio" id="credit" autocomplete="off" checked>
                    <label class="btn btn-outline-primary " style="margin-right: 5px;border-radius: 0px;" for="credit">Credit</label>

                    <input type="radio" class="btn-check" name="btnradio" id="cash" autocomplete="off">
                    <label class="btn btn-outline-success"style="margin-right: 5px;border-radius: 0px;" for="cash">Cash</label>

                    <input type="radio" class="btn-check" name="btnradio" id="cheque" autocomplete="off">
                    <label class="btn btn-outline-warning"style="margin-right: 5px;border-radius: 0px;" for="cheque">Cheque</label>

                    <input type="radio" class="btn-check" name="btnradio" id="online" autocomplete="off">
                    <label class="btn btn-outline-danger" style="border-radius: 0;" for="online">Online</label>
                  </div>
            </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
              <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="enable_round" name="enable_round" class="custom-control-input" value="1">
                  <label class="custom-control-label" for="enable_round">Yes</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="enable_round1" name="enable_round" class="custom-control-input" value="0" checked="">
          ...
          <div class="col-sm-6"><h5 class="font-italic font-weight-bold">Total Amount</h5></div>
            <div class="col-sm-6 text-right"><h5 class="font-weight-bold grand_total"  id="grand_total_label">0</h5></div>
            <input type="hidden" name="grand_total" id="grand_total" value="0">
            <p class="text-right mt-4 px-3 w-100 grandtotalwords">Zero Rupees only.</p>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/saleinvoice/create.blade.php ENDPATH**/ ?>