    ...
    <table id="Record" class="table" style="margin-top: 20px;">
        ...
        <tbody>
            <?php
                $totalPrice = 0;
            ?>
            <?php $__currentLoopData = $salesProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
...
<?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/Excel/sales-products-reports.blade.php ENDPATH**/ ?>