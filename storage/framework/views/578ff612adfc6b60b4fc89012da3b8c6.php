                ...
                <tbody>
                    ...
                    <?php if(count($expenses) > 0): ?>
                      <?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                        <td class="footable-first-visible"><input type="checkbox" name="transport_id[]" class="single-select" value="<?php echo e($expense->id); ?>"></td>
                        ...
                        <td class="td-actions footable-last-visible">
                          <a href="#UpdateExpenseoffcanvas<?php echo e($expense->id); ?>" class="btn btn-outline-primary" data-bs-target="#UpdateExpenseoffcanvas<?php echo e($expense->id); ?>" data-bs-toggle="offcanvas" role="button" aria-controls="UpdateTransportoffcanvas"><i class="las la-pen fs-18 align-middle me-2 text-muted"></i>Edit</a>
                        </td>
                        </tr>
    ...
    <form action="<?php echo e(url ('expenses/store')); ?>" method="POST">
      ...
      <?php echo csrf_field(); ?>
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <div class="controls">
                <input type="date" placeholder="Enter Transport Name"  class="form-control <?php $__errorArgs = ['date'];
...
unset($__errorArgs, $__bag); ?>" name="expense_date" id="date" value="<?php echo e(old('date')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <div class="controls">
                <input type="text" placeholder="Enter Transport Name"  class="form-control <?php $__errorArgs = ['expense_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="expense_title" id="title" value="<?php echo e(old('expense_title')); ?>">
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <div class="controls">
                <input type="text" placeholder="Enter Transport Name"  class="form-control <?php $__errorArgs = ['expense_note'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="expense_note" id="note" value="<?php echo e(old('expense_note')); ?>">
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <div class="controls">
                <input type="text" placeholder="Enter Transport Name"  class="form-control <?php $__errorArgs = ['expense_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="expense_amount" id="amount" value="<?php echo e(old('expense_amount')); ?>">
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="offcanvas offcanvas-end Productroffcanvas" tabindex="-1" id="UpdateExpenseoffcanvas<?php echo e($expense->id); ?>" aria-labelledby="UpdateExpenseoffcanvasLabel">
  <div class="offcanvas-header border-bottom">
...
unset($__errorArgs, $__bag); ?>" name="expense_date" id="date" value="<?php echo e($expense->date); ?>">
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="expense_title" id="title" value="<?php echo e($expense->title); ?>">
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="expense_note" id="note" value="<?php echo e($expense->additional_note); ?>">
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="expense_amount" id="amount" value="<?php echo e($expense->amount); ?>">
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/expenses/index.blade.php ENDPATH**/ ?>