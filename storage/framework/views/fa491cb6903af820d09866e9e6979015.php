        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-end align-items-center">
                <div class="col-4 pl-0">
                    <h4>Purchase Outstanding Report</h4>
                </div>
        ...
        <div class="main-form-container mt-4 bg-white">
            <div class="container">
                ...
                <div class="form_body mt-4 px-2 py-4">
                    <form action="<?php echo e(url('/purchase-outstandings-invoice')); ?>" id="sale_form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                    ...
                    <div class="card border-0">
                        <div class="card-header bg-white border-0">
                            ...
                            <div class="sale_register d-flex justify-content-center flex-column align-items-center">
                                <h4 class="sale_info text-capitalize">Purchase Outstandings Report</h4>
                        ...
                        <div class="card-body p-0">
                                                ...
                                                <table class="table table-hover table-nowrap align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            $grandtotal = 0;
                                                        ?>
                                                        <?php $__currentLoopData = $purchaseOutstandings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outstandings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td></td>
                            ...
                            <div class="d-flex justify-content-end py-4 gap-2 ">
                                ...
                                <a href="<?php echo e(url('/export-purchase-outstandings-report')); ?>" class="btn btn-success mr-4">Export</a>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/purchase-outstandings-report.blade.php ENDPATH**/ ?>