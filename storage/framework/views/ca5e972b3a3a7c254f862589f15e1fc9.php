            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="controls " id="companybilling" data-select2-id="companybilling" >
                   <input type="text" name="customer_name" id="customer_name" class="form-control" readonly="true" value="<?php echo e($invoice->pos_customerName); ?>"  >
                  ...
                  <input type="hidden" value="<?php echo e($invoice->customer_vendor_id); ?>" id="customer_vendor_id" name="customer_vendor_id">
                </div>
              </div>
            </div>
                    ...
                    <tr class="product-item-row">
                        ...
                        <td>
                            ...
                            <input type="text" name="price[]" class="form-control rate" placeholder="Price" style="width:100px;"
                              ...
                              <input type="hidden" name="sell_price_with_tax[]" class="sell_price_with_tax" value="2299.00">
                            </center>
                        </td>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/point-of-sale/edit.blade.php ENDPATH**/ ?>