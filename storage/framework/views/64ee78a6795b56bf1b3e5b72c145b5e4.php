                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <img width="100" src="file:///<?php echo e(public_path().'/storage/'.$organization->logo_image); ?>" alt="Invoice logo">
                                                                <?php endif; ?>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="invoice-from">
                                                                    <ul class="list-unstyled text-left">
                                                                        ...
                                                                        <li  style=" display: block;width: auto;"><?php if($organization->address1): ?>
                                                                            <?php echo e($organization->address1); ?>

                                                                            <?php endif; ?></li>
                                                                        <li  style=" display: block;width: auto;"><?php if($organization->city): ?>
                                                                            <?php echo e($organization->city); ?>

                                                                            <?php endif; ?></li>
                                                                        <li  style=" display: block;width: auto;"><?php if($organization->pincode): ?>
                                                        ...
                                                        <tr>
                                                            <td colspan="6" style="width: 50%;">
                                                                ...
                                                                <p><b
                                                                    ...
                                                                    <span
                                                                        style="display: inline-block;vertical-align: top;"><?php echo e($invoice->address1); ?><br /><?php echo e($invoice->states_name); ?> - <?php echo e($invoice->pincode); ?></span>
                                                                </p>
                                                                <p><b
                                                        ...
                                                        <?php if( count($invoice_items) > 0  ): ?>
                                                            ...
                                                            <?php $__currentLoopData = $invoice_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="border:1px solid #000000; padding:5px"><?php echo e($item->product_name); ?></td>
                                                        ...
                                                        <tr>
                                                            <td colspan="6"
                                                                ...
                                                                <p style="margin-bottom:3px"><b
                                                                        ...
                                                                        name</b> <span
                                                                        style="display: inline-block;vertical-align: top;"><?php echo e($banks->bank_name); ?></span>
                                                                </p>
                                                                <p style="margin-bottom:3px"><b
                                                                        style="display: inline-block;vertical-align: top;width:110px">Account
                                                                        no.</b>
                                                                    <span
                                                                        style="display: inline-block;vertical-align: top;"><?php echo e($banks->account_no); ?></span>
                                                                </p>
                                                                <p style="margin-bottom:3px"><b
                                                                        style="display: inline-block;vertical-align: top;width:110px">Branch
                                                                        & IFSC</b>
                                                                    <span
                                                                        style="display: inline-block;vertical-align: top;"><?php echo e($banks->branch_name); ?> <?php echo e($banks->ifsc_code ? '& '.$banks->ifsc_code : ''); ?></span>
                                                                </p>
                                                            </td>
                                                            <td colspan="5"
...
<?php echo $__env->make('layouts.print', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Work\NewBilling\resources\views/saleinvoice/print_pdf.blade.php ENDPATH**/ ?>