    ...
    <table id="Record" class="table" style="margin-top: 20px;">
        <thead >
          <tr >
            ...
            <th colspan="2" style="background-color: #000080; color:#fff;"><b>Total Amount</b></th>
            <th colspan="2" style="background-color: #000080; color:#fff;"><b>Remaining Amount</b></th>
            <th colspan="2" style="background-color: #000080; color:#fff;"><b>Due From Days</b></th>
          </tr>
        </thead>
        <tbody>
            <?php
                ...
                $grandtotal = 0;
            ?>
            <?php $__currentLoopData = $purchaseOutstandings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td colspan="2"><?php echo e(number_format($data->item_total - $data->payment_received, 2, '.', '')); ?>

                    <td colspan="2"><?php echo e("15 days"); ?>

                    </tr>
                <?php
                    $grandtotal += $data->item_total;
                    $remainingtotal += number_format($data->item_total - $data->payment_received, 2, '.', '');
                ?>
...
<?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/Excel/purchase-outstandings-reports.blade.php ENDPATH**/ ?>