...
<form action="<?php echo e(url('/invoice-setting')); ?>" method="post" id="add-saleinvoice-form">
<?php echo csrf_field(); ?>
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-end align-items-center">
                ...
                <div class="col-8 text-right">
                    <a href="<?php echo e(url('/')); ?>" class="btn btn-light mr-2">Cancel</a>
        ...
        <div class="main-form-container">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="enable_round" name="enable_round"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->enable_round == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="enable_round">Yes</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="enable_round1" name="enable_round"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->enable_round == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="due_date" name="due_date"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->due_date == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="due_date">Show</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="due_date1" name="due_date"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->due_date == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="challan_date_no"  name="challan_date_no"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->challan_date_no == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="challan_date_no">Show</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="challan_date_no1" name="challan_date_no"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->challan_date_no == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="e_way_no" name="e_way_no"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->e_way_no == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="e_way_no">Show</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="e_way_no1" name="e_way_no"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->e_way_no == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="transport" name="transport"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->transport == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="transport">Show</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="transport1" name="transport"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->transport == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="discount_box" name="discount_box"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->discount_box == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="discount_box">Show</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="discount_box1" name="discount_box"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->discount_box == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-9">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="pan_no" name="pan_no"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->pan_no == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="pan_no">Show</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="pan_no1" name="pan_no"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->pan_no == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-3">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="show_price_last" name="show_price_last"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->show_price_last == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="show_price_last">Show</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="show_price_last1" name="show_price_last"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->show_price_last == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-3">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="allow_oversell" name="allow_oversell"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->allow_oversell == 1? 'checked': ''); ?>>
                                <label class="custom-control-label" for="allow_oversell">Show</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="allow_oversell1" name="allow_oversell"
                                    class="custom-control-input" value="0" <?php echo e($general_settings->allow_oversell == 0? 'checked': ''); ?>>
                        ...
                        <div class="col-sm-3">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="default_first_page" name="default_first_page"
                                    class="custom-control-input" value="1" <?php echo e($general_settings->default_first_page == 1? 'checked': ''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="default_first_page1" name="default_first_page"
                                    class="custom-control-input" value="2" <?php echo e($general_settings->default_first_page == 2? 'checked': ''); ?>>
            ...
            <div class="setting-tab">
                ...
                <div class="tab-content bg-grey" id="myTabContent">
                    <?php if(isset($invoice_option) && count($invoice_option) > 0): ?>
                        <?php $__currentLoopData = $invoice_option; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>  $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="hidden" name="id[]" value="<?php echo e($option->id); ?>">
                        <div class="tab-pane fade show <?php if($key == 0): ?> active <?php endif; ?>" id="<?php echo e($option->type); ?>" role="tabpanel" aria-labelledby="<?php echo e($option->type); ?>-tab">
                            <div class="row mx-0">
                                <div class="col-11 py-3">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="po_no<?php echo e($key); ?>" name="po_no[<?php echo e($key); ?>]"
                                                    class="custom-control-input" value="1"  <?php echo e($option->po_no == 1 ? 'checked': ''); ?> >
                                                <label class="custom-control-label" for="po_no<?php echo e($key); ?>">Yes</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="po_no_<?php echo e($key); ?>" name="po_no[<?php echo e($key); ?>]"
                                                    class="custom-control-input" value="0" <?php echo e($option->po_no == 0 ? 'checked': ''); ?>>
                                                <label class="custom-control-label" for="po_no_<?php echo e($key); ?>">No</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="lr_no<?php echo e($key); ?>" name="lr_no[<?php echo e($key); ?>]"
                                                    class="custom-control-input"  value="1" <?php echo e($option->lr_no == 1 ? 'checked': ''); ?> >
                                                <label class="custom-control-label" for="lr_no<?php echo e($key); ?>">Yes</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="lr_no_<?php echo e($key); ?>" name="lr_no[<?php echo e($key); ?>]"
                                                    class="custom-control-input" value="0" <?php echo e($option->lr_no == 0 ? 'checked': ''); ?>>
                                                <label class="custom-control-label" for="lr_no_<?php echo e($key); ?>">No</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="invoice_no_prefix[]" id="invoice_no_prefix_<?php echo e($key); ?>" value="<?php echo e($option->invoice_no_prefix); ?>" placeholder="Enter Prefix">
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="alert alert-warning mt-0" role="alert">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="invoice_no_postfix[]" id="invoice_no_postfix<?php echo e($key); ?>" value="<?php echo e($option->invoice_no_postfix); ?>"  placeholder="Enter Postfix">
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="alert alert-warning mt-0" role="alert">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="term_condition_title[]" id="term_condition_title<?php echo e($key); ?>" value="<?php echo e($option->term_condition_title); ?>" 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <textarea class="form-control" rows="4"
                                                placeholder="Enter text here" name="term_condition[]" id="term_condition<?php echo e($key); ?>"  ><?php echo e($option->term_condition); ?></textarea>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="alert alert-warning mt-0" role="alert">
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/setting/invoice_setting.blade.php ENDPATH**/ ?>