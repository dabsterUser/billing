...
<div class="page-content">
  <div class="container-fluid">
    ...
    <div class="row pb-4 gy-3">
        <div class="col-sm-4">
            <a href="<?php echo e(url('purchase-invoice/create')); ?>" class="btn btn-primary addMembers-modal"><i class="las la-plus me-1"></i> Add Invoices</a>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td> 
                                      <div class="col-xl-3 col-lg-4 col-sm-6">
                                        ...
                                        <a href="" class="text-body align-middle fw-medium"><?php echo e($invoice->customer_name); ?></a>
                                      </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(url('print-invoice-purchase')); ?>?id=<?php echo e($invoice->id); ?>"><i class="las la-eye fs-18 align-middle me-2 text-muted"></i>
                                                        View & Print</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(url('purchase-invoice/'.$invoice->id.'/edit')); ?>"><i class="las la-pen fs-18 align-middle me-2 text-muted"></i>
                                                        Edit</a>
                                                </li>
                                                <li>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/purchaseinvoice/index.blade.php ENDPATH**/ ?>