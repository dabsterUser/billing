              ...
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  ...
                  <div class="page-title-right">
                      <ol class="breadcrumb m-0">
                          <li class="breadcrumb-item"><a href="javascript: void(0);">Outward Payment</a></li>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo e(url('purchase-receipt')); ?>" method="post" id="add-receipt-form">
                <?php echo csrf_field(); ?>
                <div class="row">
                  ...
                  <div class="col-md-6 mt-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <input type="hidden" name="gstin_pan" id="gstin_pan" class="form-control"
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/purchaseinvoicereceipt/create.blade.php ENDPATH**/ ?>