    ...
    <table id="Record" class="table" style="margin-top: 20px;">
        ...
        <tbody>
            <?php
                $totalPrice = 0;
            ?>
            <?php $__currentLoopData = $purchaseInward; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td colspan="2"><?php echo e($data->payment_date); ?></td>
                    <td colspan="2"><?php echo e($data->name); ?></td>
...
<?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/Excel/purchase-inward-reports.blade.php ENDPATH**/ ?>