    ...
    <table id="Record" class="table" style="margin-top: 20px;">
        <thead >
          <tr >
            ...
            <th colspan="2" style="background-color: #000080; color:#fff;"><b>Particulars</b></th>
            <th colspan="2" style="background-color: #000080; color:#fff;"><b>Vch Type</b></th>
            <th colspan="2" style="background-color: #000080; color:#fff;"><b>Vch No</b></th>
        ...
        <tbody>
            <?php
                $totalPrice = 0;
            ?>
            <?php $__currentLoopData = $salesInward; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td colspan="2"><?php echo e($data->payment_date); ?></td>
                    <td colspan="2"><?php echo e($data->name); ?><br /> <small><b><?php echo e($data->payment_type); ?></b></small></td>
                    <td colspan="2"><?php echo e($data->payment_type); ?></td>
                    <td colspan="2"><?php echo e($data->receipt_no); ?></td>
                    <td colspan="2"><?php echo e($data->amount); ?></td>
                    </tr>
                <?php
...
<?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/Excel/sales-inward-reports.blade.php ENDPATH**/ ?>