...
<div class="container-fluid main-container">
  <div class="main-form-container">
        ...
        <div class="col-sm-3">
          <div class="">
            <div class="">
              ...
              <div class="total-counter"><i>Till Date</i><br><b><?php echo e($product_count); ?> Products</b></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <?php if(\Session::has('success')): ?>
        <div class="alert alert-success p-3 font-weight-bold">
          ...
          <table class="table table-hover" data-footable="" id="product-datatable" data-toggle-column="last"
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="<?php echo e(asset('/images')); ?>/<?php echo e($product->product_image); ?>" width="70" height="70"></td>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <a href="#"  data-toggle="modal" data-target="#updateStock<?php echo e($product->id); ?>">
                ...
                <td class="td-actions footable-last-visible">
                  ...
                  <a href="javascript:;" onclick="get_product_by_id('<?php echo e($product->id); ?>')" data-toggle="modal" data-target="#editProductModal<?php echo e($product->id); ?>" class="btn btn-outline-primary">
                    <i class="icon icon-pencil"></i>Edit
                  </a>

                  
                  <div class="modal right" id="editProductModal<?php echo e($product->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Work\NewBilling\resources\views/product/index.blade.php ENDPATH**/ ?>