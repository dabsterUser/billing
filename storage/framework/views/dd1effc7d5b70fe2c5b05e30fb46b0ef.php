    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-end align-items-center">
            ...
            <div class="col-8 text-right">
				...
				<a href="<?php echo e(url('print-invoice-downloadpdf?'.$url)); ?>" class="btn btn-light mr-2">Download PDF</a>
                <!--<button id="" name="" value="" class="btn btn-primary">Print</button>-->

                <a target="_blank" href="<?php echo e(url('print-invoice?'.$url.'&download=pdf')); ?>">Print</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Work\NewBilling\resources\views/saleinvoice/print.blade.php ENDPATH**/ ?>