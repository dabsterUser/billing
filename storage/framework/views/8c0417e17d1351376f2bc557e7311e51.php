        ...
        <div class="main-form-container mt-4 bg-white">
            <div class="container">
                ...
                <div class="form_body mt-4 px-2 py-4">
                    <form action="<?php echo e(url('/sales-outstandings-invoice')); ?>" id="sale_form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body p-0">
                                                ...
                                                <table class="table table-hover table-nowrap align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            $grandtotal = 0;
                                                        ?>
                                                        <?php $__currentLoopData = $salesOutstandings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outstandings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td></td>
                                                            <td> <?php echo e($outstandings->bill_date); ?> </td>
                                                            <td><p class="fw-medium mb-0"><?php echo e($outstandings->name); ?></p></td>
                                                            <td>
                                                                <a href="#javascript: void(0);" class="text-body align-middle fw-medium"><?php echo e($outstandings->invoice_number); ?></a>
                                                            </td>
                                                            <td><?php echo e($outstandings->item_total); ?></td>
                                                            <td><?php echo e(number_format($outstandings->grand_total - $outstandings->payment_received, 2, '.', '')); ?></td>
                                                            <td>15 days</td>
                                                        </tr>
                                                        <?php
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td scope="col"></td>
                                                        <td scope="col"><?php echo e(number_format($grandtotal, 2, '.', '')); ?></td>
                                                        <td scope="col"><?php echo e($remainingtotal); ?></td>
                                                        <td scope="col"></td>
                                                    </tfoot>
                                                </table><!-- end table -->
                            ...
                            <div class="d-flex justify-content-end py-4 gap-2 ">
                                <a href="<?php echo e(url('print-sales-outstandings-report')); ?>" target="_blank" class="btn btn-success mr-4">Print</a>
                                <a href="<?php echo e(url('/export-outstandings-sales-report')); ?>" class="btn btn-success mr-4">Export</a>
                                <a href="<?php echo e(url('print-sales-outstandings-report')); ?>" target="_blank" class="btn btn-success mr-4">Download PDF</a>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/sales-outstandings-report.blade.php ENDPATH**/ ?>