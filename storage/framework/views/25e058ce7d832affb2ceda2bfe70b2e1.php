    ...
    <div class="container-fluid">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Inward Payments</li>
      ...
      <div class="row pb-4 gy-3">
        <div class="col-sm-4">
            ...
            <a class="btn btn-primary" href="<?php echo e(url('/sale-receipt/create')); ?>" ><i class="las la-plus me-1"></i>Add Receipt </a>      
        </div>
            ...
            <?php if(count($salereceipt)>0): ?>
              <?php $__currentLoopData = $salereceipt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo e(url('/sale-receipt/'.$receipt->id.'/edit')); ?>" class="btn btn-outline-primary"> <i class="las la-pen fs-18 align-middle me-2 text-muted"></i>Edit</a>
                  </td>
                  <td class="footable-last-visible">
                  <p>
                    <a href="<?php echo e(url('print-inward')); ?>?id=<?php echo e($receipt->id); ?>" class="btn btn-outline-success print-btn" target="_blank" data-link="<?php echo e(url('print-inward')); ?>?id=<?php echo e($receipt->id); ?>" data-id="<?php echo e($receipt->id); ?>" > <i class="ri-printer-line fs-18 align-middle me-2 text-muted"></i>Print</a></p>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/saleinvoicereceipt/index.blade.php ENDPATH**/ ?>