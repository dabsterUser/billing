                                            ...
                                            <div class="invoice-items">
                                              <div class="logo">
                                                <div class="invoice-logo" style="display: inline-block;width:50%">
                                                  ...
                                                  <img width="70" src="file:///<?php echo e(public_path().'/storage/'.$organization->logo_image); ?>" alt="Invoice logo">
                                                  <?php endif; ?>
                                                </div>
                                                                    ...
                                                                    style="border-top:0px; border-left:0px;border-right:1px solid #000;padding:4px 4px 20px; ">
                                                                      <ul class="list-unstyled text-left mb-0">
                                                                          ...
                                                                          <p><b
                                                                              ...
                                                                              <span
                                                                                  style="display: inline-block;vertical-align: top;"><?php echo e($invoice->states_name); ?> - <?php echo e($invoice->pincode); ?></span>
                                                                          </p>
                                                                          <p><b
                                                                          ...
                                                                          <p style="display: block"><b
                                                                              ...
                                                                              <span
                                                                                  style="display: inline-block;vertical-align: top;"> <?php echo e($invoice->gstin ? $invoice->gstin : ''); ?></span>
                                                                          </p>
                                                                          <p><b
                                                                                  style="display: inline-block;vertical-align: top;width:80px">PAN</b>
                                                                              <span
                                                                                  style="display: inline-block;vertical-align: top;"> <?php echo e($invoice->pan ? $invoice->pan : ''); ?></span>
                                                                          </p>
                                                                      </ul>
                                                              </div>
...
<?php echo $__env->make('layouts.print', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/purchaseinvoice/print_pdf.blade.php ENDPATH**/ ?>