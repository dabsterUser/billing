    ...
    <div class="main-form-container mt-4 bg-white">
        <div class="container">
            ...
            <div class="form_body mt-4 px-2 py-4">
                <form action="<?php echo e(url('/company-outstandings-report-invoice')); ?>" >
                    <?php echo csrf_field(); ?>
                    <div class="row">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $customerData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td class="text-capitalize"><?php echo e($customer->type); ?></td>
                                            <td></td>
                                            <td><?php echo e($totalLastMonthOutstandings); ?></td>
                                            <td><?php echo e($creditAmount); ?></td>
                                            <td><?php echo e($debitAmount); ?></td>
                                            <td><?php echo e($debitAmount -  $creditAmount); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/other-reports/company-outstandings-report.blade.php ENDPATH**/ ?>