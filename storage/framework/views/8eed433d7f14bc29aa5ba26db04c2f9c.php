...
<form action="<?php echo e(url('/purchase-invoice')); ?>" method="post" id="add-saleinvoice-form">
    ...
    <div class="container-fluid">
      <div class="row d-flex justify-content-end align-items-center">
        ...
        <div class="col-8 d-flex justify-content-end">
          <a href="<?php echo e(url('/purchase-invoice')); ?>" class="btn btn-light mr-2">Cancel</a>
        ...
        <div class="col-6">
          <div class="row">
            <div class="col text-right">
              <a href="#" class="btn btn-link px-0 pt-3 pb-3" data-toggle="modal" data-target="#customerModal">Add New Vendor</a>
            </div>
          </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="controls mt-2">
                  <label><input type="checkbox" name="is_same_shipping" value="1" checked id="is_same_shipping_invoice"> Use
          ...
          <table class="table table-bordered addinvoice-table mb-0" id="document-item-list">
            ...
            <tbody class="ui-sortable product-list-row">
              <tr class="product-item-row">
                ...
                <td>
                  <input type="number" name="quantity[]" autocomplete="off" id="input_number" class="form-control quantity" placeholder="Qty."
                ...
                <td>
                  ...
                  <input type="hidden" name="purchase_price_with_tax[]" class="purchase_price_with_tax" value="0">
                ...
                <td>
                  <center>
                    <button type="button" value="" class="btn btn-remove-row btn-lg bg-light-danger"><i
            ...
            <tfoot>
              <tr class="">
                ...
                <td>
                    <input type="hidden" name="total_without_tax" class="total_without_tax" value="0">
...
<script src="<?php echo e(asset('public/js/purcahse-customer.js')); ?>"></script>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/purchaseinvoice/create.blade.php ENDPATH**/ ?>