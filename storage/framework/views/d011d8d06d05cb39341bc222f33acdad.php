        ...
        <div class="main-form-container mt-4 bg-white">
            <div class="container">
                <div class="form_body mt-4 px-2 py-4">
                    <form action="<?php echo e(url('/purchase-product-invoice')); ?>" id="sale_form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/purchase-product-report.blade.php ENDPATH**/ ?>