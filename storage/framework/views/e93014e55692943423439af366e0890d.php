...
<div class="container-fluid">
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/jquery.selectlistactions.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/invoice-receipt.js')); ?>"></script>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Work\NewBilling\resources\views/purchaseinvoicereceipt/create.blade.php ENDPATH**/ ?>