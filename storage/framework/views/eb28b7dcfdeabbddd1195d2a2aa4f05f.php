    ...
    <div class="main-form-container">
        <div class="container">
            ...
            <div class="form_body mt-5">
                <form action="<?php echo e(url('/company-ledger-report-invoice')); ?>" >
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="table-responsive-sm">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $closingBalance = 0;
                                    ?>
                                    <?php $__currentLoopData = $companyLedger; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                        <tr>
                                            <td> <?php echo e($data->bill_date); ?></td>
                                            <td><?php echo e("Taxable values"); ?> <?php echo e($data->item_total); ?></td>
                                            <td></td>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/other-reports/company-ledger-report.blade.php ENDPATH**/ ?>