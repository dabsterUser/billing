        ...
        <div class="container-fluid">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="">
                    ...
                    <a href="<?php echo e(url('download-pdf-purchase-inward?'.$url)); ?>" class="btn btn-light mr-2">Download PDF</a>
                    <a target="_blank" href="<?php echo e(url('print-purchase-inward?'.$url.'&download=pdf')); ?>">Print</a>
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <tr>
                                                <td style="position:relative;vertical-align: top;">
                                                    <table cellspacing="0" cellpadding="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td class="org_orgname_logo"
                                                                    data-editor=".org_orgname_logo">
                                                                    Epiliam </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="org_address_logo"
                                                                    data-editor=".org_address_logo">
                                                                    <?php echo e($payment_receipt->address); ?> </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="contact_details"
                                                                    ...
                                                                    <b>Name</b> :<?php echo e($user_details->name); ?>
                                                            ...
                                                            <tr>
                                                                <td class="contact_details">
                                                                    <b>Email</b> : <?php echo e($user_details->email); ?>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="width: 35%;" class="gstin"
                                                                                    data-editor=".gstin"><span
                                                                                        style="">PAN
                                                                                        :</span><?php echo e($organization->gstin); ?>
                                                    ...
                                                    <table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td class="customerdata_item_label"
                                                                                    ...
                                                                                    M/S</td>
                                                                                <td class="special"
                                                                                    data-editor=".customerdata td.special">
                                                                                    <?php echo e($payment_receipt->name); ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="customerdata_item_label">
                                                                                    Address</td>
                                                                                <td style="">
                                                                                    <div style="overflow: hidden;">
                                                                                        <?php echo e($payment_receipt->address); ?>,
                                                                                        <?php echo e($payment_receipt->state_name); ?>
                                                                            ...
                                                                            <tr>
                                                                                <td class="customerdata_item_label">
                                                                                    PHONE</td>
                                                                                <td style=""><?php echo e($payment_receipt->phone); ?>
                                                                            ...
                                                                            <tr>
                                                                                <td class="customerdata_item_label">
                                                                                    GSTIN </td>
                                                                                <td style="">
                                                                                    <?php echo e($payment_receipt->gstin_pan); ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="customerdata_item_label">
                                                                                    State </td>
                                                                                <td style="">
                                                                                    ...
                                                                                    (<?php echo e($payment_receipt->state_code); ?>)
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                ...
                                                                <td
                                                                    style="border-bottom:1px solid #0070C0;vertical-align:top;">
                                                                    <table cellspacing="0" class="invoicedata">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td class="invoicedata_item_label">
                                                                                    <?php echo e($payment_receipt->receipt_no); ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="invoicedata_item_label">
                                                                                    Voucher Date</td>
                                                                                <td>&nbsp;</td>
                                                                                <td><?php echo e($payment_receipt->payment_date); ?>
                                    ...
                                    <table class="tableboxLinetable" cellspacing="0" cellpadding="0" border="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="tableboxLine linebox2"
                                                    style="width: 27%; left: 4%; height: 446px;">
                                                </td>
                                                <td class="tableboxLine linebox3"
                                                    style="width: 11%; left: 31%; height: 446px;">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr class="pageRow1">
                                                ...
                                                <td class="txt-left" style="margin-left:20px;">
                                                    <b>Account</b><br>
                                                    <?php echo e($payment_receipt->name); ?><br>
                                                    <?php $__currentLoopData = $invoice_nos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    invoice no : <?php echo e($invoice); ?><br>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <b>Through</b><br>
                                                    <?php echo e($payment_receipt->payment_type); ?>

                                                </td>
                                                <td class="txt-right " style="">
                                                    <br>
                                                    <br>
                                                    <?php echo e($payment_receipt->amount); ?>
                                    ...
                                    <table class="invoicedataFooter" cellspacing="0" style="width:100%;"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="txt-bold txt-right"><?php echo e($payment_receipt->amount); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table cellspacing="0" cellpadding="0" class="invoice">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="txt-bg"
                                                                                    ...
                                                                                    Total Amount</td>
                                                                                <td class="txt-bg txt-right">
                                                                                    <?php echo e($payment_receipt->amount); ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2" class="txt-right">(E
                                                                                    &amp; O.E.)
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2"
                                                                                    class="footer_seal_title"
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="2" class="footer_seal_name"
                                                                                    ...
                                                                                    For <?php echo e($user_details->name); ?></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2"
...
<script>
$(".amount_in_words").text(number2text({
    {
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/purchaseinvoicereceipt/print.blade.php ENDPATH**/ ?>