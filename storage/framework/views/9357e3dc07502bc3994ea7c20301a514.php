                                            ...
                                            <div class="invoice-items">
                                              <div class="logo">
                                                <div class="invoice-logo" style="display: inline-block;width:50%">
                                                          ...
                                                          <img width="70" src="<?php echo e(asset('public/org_logos/'.$organization->logo_image)); ?>" alt="Invoice logo">
                                                          <?php endif; ?>
                                                </div>
                                                                  ...
                                                                  <table style="width: 100%" class="table_2">  
                                                                    <tr style="border-bottom: 1px solid #000;padding-bottom:10px;">
                                                                        <td style="border-right: 1px solid #000;width:50%">
                                                                          <p>Invoice No.</p>
                                                                          <p><b><?php echo e($invoice->invoice_prefix); ?>

                                                                            <?php echo e($invoice->invoice_number); ?>

                                                                            <?php echo e($invoice->invoice_postfix); ?></b></p>
                                                                        </td>
                                                                        <td>
                                                                          <p>Date:</p>
                                                                          <p><b><?php echo e($invoice->bill_date ? \Carbon\Carbon::now()->toDateString($invoice->bill_date, 'd-M-Y') : ''); ?></b></p>
                                                                        </td>
                                                                      </tr> 
                                                                    <tr style="border-bottom: 1px solid #000">
                                                                        <td style="border-right: 1px solid #000;width:50%">
                                                                          <p>Challan Date:</p>
                                                                          <p><b><?php echo e($invoice->challan_date ? \Carbon\Carbon::now()->toDateString($invoice->challan_date, 'd-M-Y') : ''); ?></b></p>
                                                                        </td>
                                                                        <td>
                                                                          <p>P.O
                                                                            no.</p>
                                                                          <p><b> <?php echo e($invoice->order_no ? $invoice->order_no : ''); ?></b></p>
                                                                        </td>
                                                                      </tr> 
                                                                    <tr style="border-bottom: 1px solid #000">
                                                                        <td style="border-right: 1px solid #000;width:50%">
                                                                          <p>L.R no.</p>
                                                                          <p><b><?php echo e($invoice->lrno ? $invoice->lrno : ''); ?></b></p>
                                                                        </td>
                                                                        <td>
                                                                          <p>E-Way
                                                                            no.</p>
                                                                          <p><b><?php echo e($invoice->eway ? $invoice->eway : ''); ?></b></p>
                                                                        </td>
                                                                      </tr> 
                                                                    <tr style="border-bottom: 1px solid #000">
                                                                        <td style="border-right: 1px solid #000;width:50%">
                                                                          <p>Transport:</p>
                                                                          <p><b><?php echo e($invoice->tranport_name ? $invoice->tranport_name : ''); ?></b></p>
                                                                        </td>
                                                                        <td>
                                                                          <p>Trans
                                                                            ID:</p>
                                                                          <p><b><?php echo e($invoice->transport_transport_id ? $invoice->transport_transport_id : ''); ?>
                                                                    ...
                                                                    <tr style="border-bottom: 1px solid #000">
                                                                        <td style="border-right: 1px solid #000;width:50%">
                                                                          <p>Vehicle
                                                                            no.</p>
                                                                          <p><b> <?php echo e($invoice->transport_vehicle_no ? $invoice->transport_vehicle_no : ''); ?></b></p>
                                                                        </td>
                                                                        <td>
                                                                          <p>Place
                                                                            of supply:</p>
                                                                          <p><b><?php echo e($invoice->states_name ? $invoice->states_name . '(' . $invoice->scode . ')' : ''); ?>
                                                ...
                                                <table style="border: 1px solid #000000; border-top:0px;width:100%;">
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr style="border-bottom:1px solid #000!important">
                                                                ...
                                                                <td
                                                                    ...
                                                                    <p><b><?php echo e($item->hidden_item_product_name); ?></b></p>
                                                                ...
                                                                <td style="border-right:1px solid #000;padding:5px;border-bottom:1px solid #000; ">
                                                                    <p><b><?php echo e($item->quantity); ?></b></p>
                                                                </td>
                                                                <td style="border-right:1px solid #000;padding:5px;border-bottom:1px solid #000; ">
                                                                    <p></p>
                                                                </td>
                                                                ...
                                                                <td style="border-right:1px solid #000;padding:5px;border-bottom:1px solid #000; ">
                                                                    <p><?php echo e($item->hidden_item_product_name); ?></p>
                                                                </td>
                                                                <td  class="text-right"
                                                                    style="padding:5px;border-bottom:1px solid #000;">
                                                                    <p style="display:block;text-align:right;"><b><?php echo e(number_format(round($item->total), 2)); ?></b></p>
                                                                    <table style="width:100%;margin:50px 0px 90px;">
                                                                    <tr>
                                                                    <td><p style="display:block;text-align:right;"><b><?php echo e(number_format($cgst, 2)); ?></b></p></td>
                                                                    </tr>
                                                                    <tr>
                                                                    <td><p style="display:block;text-align:right;"><b><?php echo e(number_format($sgst, 2)); ?></b></p></td>
                                                                    </tr>
                                                                    <tr>
                                                                    <td><p style="display:block;text-align:right;"><b><?php echo e(number_format($roundoff, 2)); ?></b></p></td>
                                                                    </tr>
                                                                    </table>
                                                    ...
                                                    <tfoot class="text-center" style="border-top:1px solid #000 ">
                                                        ...
                                                        <td  class="text-right"
                                                            style="padding:5px">
                                                            <p style="display: block;text-align:right; text-transform:capitalize;"><b>INR <?php echo e(number_format(round($ProductTotal), 2)); ?></b></p>
                                                        </td>
                                                ...
                                                <div class="word_price" style="border:1px solid #000;border-top:0px;padding:4px">
                                                    ...
                                                    ?>
                                                    <p style="font-weight:700;margin-top:5px; text-transform:capitalize;">INR <?php echo e($totalInWords); ?> Only</p>
                                                </div>
                                                <table class="table"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td 
                                                                ...
                                                                <table style="width:100%;">
                                                                    <tr>
                                                                        <td style='border-right:1px solid #000;width:50%;text-align:right;padding-right:5px'><p><?php echo e($item->gst/2); ?>%
                                                                        </p></td>
                                                                        <td style="padding-left: 4px"><p ><?php echo e(number_format($second_cgst, 2)); ?></p></td>
                                                                    </tr>
                                                                    </table>
                                                            </td>
                                                            <td 
                                                                ...
                                                                <table style="width:100%;">
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding-left: 4px"><p ><?php echo e(number_format($second_sgst, 2)); ?> </p></td>
                                                                    </tr>
                                                                    </table>
                                                            </td>
                                                            ...
                                                            <td 
                                                                ...
                                                                <table style="width:100%;padding:0px;">
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding-left: 4px"><p ><b><?php echo e(number_format($TotalCgst,2)); ?></b></p></td>
                                                                    </tr>
                                                                    </table>
                                                            ...
                                                            <td 
                                                                ...
                                                                <table style="width:100%;">
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding-left: 4px"><p ><b><?php echo e(number_format($TotalSgst,2)); ?></b></p></td>
                                                                    </tr>
                                                                    </table>
                                                            </td>
                                                            <td   style="border-right:1px solid #000;padding:5px">
                                                ...
                                                <div class="decs "
                                                    ...
                                                    <div class="amt d-flex ">
                                                        ...
                                                        <p style="font-size: 16px; display:inline-block; text-transform:capitalize;"><b>: INR <?php echo e($totalInWords); ?> Only</b></p>
...
<?php echo $__env->make('layouts.print', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/saleinvoice/print_pdf.blade.php ENDPATH**/ ?>