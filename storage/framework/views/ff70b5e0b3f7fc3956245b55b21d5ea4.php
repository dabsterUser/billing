...
<form action="<?php echo e(url('/purchase-invoice/'.$invoice->id)); ?>"  method="post" id="add-saleinvoice-form">
  ...
  <div class="top-stickybar">
    <div class="container-fluid">
      <div class="row d-flex justify-content-end align-items-center">
        ...
        <div class="col-8 text-right col-8 d-flex justify-content-end">
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/purchaseinvoice/edit.blade.php ENDPATH**/ ?>