        ...
        <div class="col-6">
          <div class="row">
            <div class="col text-right">
              <a href="#" class="btn btn-link" data-toggle="modal" data-target="#customerModal">Add New Vendor</a>
            </div>
          </div>
              ...
              <tr class="product-item-row">
                ...
                <td>
                  <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="gst[]" readonly="true" class="form-control gst" placeholder="0" style="width:50px;"
                    maxlength="5" >
                  </div>
                </td>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Work\NewBilling\resources\views/purchaseinvoice/create.blade.php ENDPATH**/ ?>