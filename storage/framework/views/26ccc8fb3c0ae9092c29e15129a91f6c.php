    ...
    <table id="Record" class="table" style="margin-top: 20px;">
        ...
        <tbody>
            <?php
                $totalPrice = 0;
            ?>
            <?php $__currentLoopData = $purchaseProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td colspan="2"><?php echo e($data->hidden_item_product_name); ?></td>
                    <td colspan="2"><?php echo e($data->total_quantity); ?></td>
                    <td colspan="2"><?php echo e($data->total_price); ?></td>
                    <td colspan="2"><?php echo e($data->total_price); ?></td>
                    </tr>
                <?php
...
<?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/Excel/purchase-products-reports.blade.php ENDPATH**/ ?>