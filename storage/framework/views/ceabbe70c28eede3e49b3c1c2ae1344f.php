        ...
        <div class="main-form-container mt-4 bg-white">
            <div class="container">
                ...
                <div class="form_body mt-4 px-2 py-4">
                    <form action="<?php echo e(url('/purchase-inward-invoice')); ?>" id="sale_form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body p-0">
                                                ...
                                                <table class="table table-hover table-nowrap align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $totalPrice = 0;
                                                        ?>
                                                        <?php $__currentLoopData = $purchaseInward; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inward): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td></td>
                            ...
                            <div class="d-flex justify-content-end py-4 gap-2 ">
                                ...
                                <a href="<?php echo e(url('/export-purchase-inward-report')); ?>" class="btn btn-success mr-4">Export</a>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/purchase-inward-reports.blade.php ENDPATH**/ ?>