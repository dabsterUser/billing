      ...
      <form method="post" id="transport-records">
            <?php echo csrf_field(); ?>
                ...
                <?php if(count($payments)>0): ?>
                    ...
                    <tr>
                    <td class="footable-first-visible"><input type="checkbox" name="reciept_id[]" class="single-select" value="<?php echo e($receipt->id); ?>"></td>
                    <td><?php echo e($receipt->receipt_no); ?></td>
                    <td><?php echo e($receipt->invoice_no); ?></td>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/receipt-history/index.blade.php ENDPATH**/ ?>