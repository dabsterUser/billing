        ...
        <div class="main-form-container mt-4 bg-white">
            <div class="container">
                <div class="form_body mt-4 px-2 py-4">
                    <form action="<?php echo e(url('/sales-product-invoice')); ?>" id="sale_form">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body p-0">
                                                ...
                                                <table class="table table-hover table-nowrap align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $totalPrice = 0;
                                                        ?>
                                                        <?php $__currentLoopData = $salesProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td></td>
                                                            <td> <?php echo e($product->hidden_item_product_name); ?> </td>
                                                            <td><p class="fw-medium mb-0"> <?php echo e($product->total_quantity); ?> </p></td>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td scope="col"><?php echo e($totalPrice); ?></td>
                                                    </tfoot>
                                                </table><!-- end table -->
                            ...
                            <div class="d-flex justify-content-end py-4 gap-2 ">
                                ...
                                <a href="<?php echo e(url('export-product-sales-report')); ?>" class="btn btn-success mr-4">Export</a>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/sales-product-report.blade.php ENDPATH**/ ?>