...
<form action="<?php echo e(url('/point-of-sale')); ?>" method="post" id="add-saleinvoice-form">
    ...
    <div class="main-form-container mt-4 mb-4">
      <div class="row mx-0">
        <div class="col-6">
          ...
          <div class="customer-information-invoice mt-4">
            ...
            <div class="row mt-2">
              ...
              <div class="col-sm-9 ">
                <input type="text" name="customer_pan"  class="form-control">
              </div>
            ...
            <div class="row mt-2">
              ...
              <div class="col-sm-9 ">
                <input type="text" name="customer_gstno"  class="form-control" >
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      <input name="challan_date" type="text"  class="form-control datepicker" autocomplete="off">
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      <input name="challan_number" type="text"  class="form-control challan_number" autocomplete="off">
                    </div>
                  </div>
                </div>
          ...
          <table class="table table-bordered addinvoice-table mb-0" id="document-item-list">
            ...
            <tbody class="ui-sortable product-list-row">
              <tr class="product-item-row">
                ...
                <td>
                  <input type="number" name="quantity[]" id="input_number" class="form-control quantity" placeholder="Qty."
                    style="width:70px;" maxlength="10" max="121"
                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                    >
                ...
                <td class="discount_field">
                  <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="discount[]" style="width:60px;" class="form-control disc"  value="0"
                    maxlength="10">
                  </div>
                  ...
                  <input type="hidden" name="taxable_line_value[]" style="width:60px;" class="taxable_line_value" value="0">
                </td>
                ...
                <td>
                  ...
                  <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="gst[]" disabled class="form-control gst" placeholder="%" style="width:60px;">
                  </div>
                  <div class="input-group mt-2">
                    <div class="input-group-prepend">
                      <div class="input-group-text">Rs</div>
                    </div>
                    <input type="text" name="cess_amount[]" class="form-control gst_amount" placeholder="Rs" style="width:60px;">
                  </div>
                  <input value="" type="hidden" name="gst_ammount[]" class="gst_amount">
                </td>
                ...
                <td>
                  <div class="input-group flex-nowrap">
                    ...
                    <input type="text" name="cess[]" class="form-control cess" placeholder="0">
                  </div>
                  <div class="input-group flex-nowrap mt-2">
                    <div class="input-group-prepend">
                      <div class="input-group-text">Rs</div>
                    </div>
                    <input type="text" name="cess_amount[]" style="width: 60px" class="form-control cess_amount" placeholder="Rs">
                  </div>
            ...
            <tfoot>
              <tr class="">
                ...
                <td>
                    <input type="hidden" name="total_gst_rate" id="total_cgst_rate" value="0">
      ...
      <div class="row mx-0 mt-4 bg-white">
        <div class="col-sm-6 border-right py-3">
          <div class="form-group">
            ...
            <textarea class="form-control" name="document_note"  placeholder="These notes not to be printed on invoice"
              rows="4"></textarea>
          </div>
          ...
          <div class="row mt-2 mb-3 payment-type">
            ...
            <div class="col-7">
                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                    <input type="radio" class="btn-check" name="payment_type" value="credit" id="credit" autocomplete="off" checked>
                    <label class="btn btn-outline-primary " style="margin-right: 5px;border-radius: 0px;" for="credit">Credit</label>

                    <input type="radio" class="btn-check" name="payment_type" value="cash" id="cash" autocomplete="off">
                    <label class="btn btn-outline-success"style="margin-right: 5px;border-radius: 0px;" for="cash">Cash</label>

                    <input type="radio" class="btn-check" name="payment_type" value="cheque" id="cheque" autocomplete="off">
                    <label class="btn btn-outline-warning"style="margin-right: 5px;border-radius: 0px;" for="cheque">Cheque</label>

                    <input type="radio" class="btn-check" name="payment_type" value="online" id="online" autocomplete="off">
                    <label class="btn btn-outline-danger" style="border-radius: 0;" for="online">Online</label>
                </div>
            </div>
        </div>
        <div class="row mt-2 mb-3 " id="cashInputs" style="display: none;">
            <div class="d-flex w-100 mt-2 mb-2">
                <div class="col-5 mt-2">
                    <label for="">Payment Received</label>
                </div>
                <div class="col-7 mt-2">
                        <input type="text" class="form-control" name="payment_recieved" id="payment_recieved" >
                </div>
            </div>
            <div class="d-flex  w-100 mt-2 mb-2">
                <div class="col-5 mt-2">
...
<script src="<?php echo e(asset('public/js/p-o-s.js')); ?>"></script>
...
<script>
    ...
    var cardRadio = document.getElementById('credit');
    var checkRadio = document.getElementById('cheque');
    var onlineRadio = document.getElementById('online');
    var cashInput = document.getElementById('cashInputs');

    cashRadio.addEventListener('change', toggleCashInputs);
    cardRadio.addEventListener('change', toggleCashInputs);
    checkRadio.addEventListener('change', toggleCashInputs);
    onlineRadio.addEventListener('change', toggleCashInputs);

    function toggleCashInputs() {
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/point-of-sale/create.blade.php ENDPATH**/ ?>