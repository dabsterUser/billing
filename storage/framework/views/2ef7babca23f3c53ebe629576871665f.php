    ...
    <table id="Record" class="table" style="margin-top: 20px;">
        ...
        <tbody>
            <?php
                ...
                $grandtotal = 0;
            ?>
            <?php $__currentLoopData = $salesOutstandings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e(number_format($data->item_total - $data->payment_received, 2, '.', '')); ?>

                    <td><?php echo e("15 days"); ?>
...
<?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/reports/Excel/sales-outstandings-reports.blade.php ENDPATH**/ ?>