...
<form action="<?php echo e(url('/sale-invoice/'.$invoice->id)); ?>"  method="post" id="add-saleinvoice-form">
  ...
  <div class="container-fluid main-container ">
    ...
    <?php echo e(method_field('PATCH')); ?>
        ...
        <div class="col-6">
          ...
          <div class="customer-information-invoice">
                ...
                <div class="controls " id="companybilling" data-select2-id="companybilling">
                  <select id="customers" class="form-control" name="customer_vendor_id" readonly="true" disabled>
                    ...
                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($customer->id); ?>" <?php echo e($invoice->customer_vendor_id == $customer->id ? 'selected':''); ?>><?php echo e($customer->name); ?></option>
            ...
            <div class="row mt-2">
              ...
              <div class="col-sm-9 customer-address-label"><?php echo e($invoice->address); ?></div>
              <input type="hidden" name="address" value="<?php echo e($invoice->address); ?>" class="address" readonly="true">
            </div>
            <div class="row mt-2">
              <div class="col-sm-3">Phone</div>
              <div class="col-sm-9 customer-phone-label"><?php echo e($invoice->phone); ?></div>
              <input type="hidden" name="phone" value="<?php echo e($invoice->phone); ?>"  class="phone" readonly="true">
            </div>
            ...
            <div class="form-group PlaceofSupply d-none">
              ...
              <select class="form-control" id="PlaceofSupply" name="PlaceofSupply" required >
                ...
                <option value="<?php echo e($state->id); ?>" <?php echo e($invoice->place_supply == $state->id ? 'selected' : ''); ?>><?php echo e($state->name); ?> (<?php echo e($state->state_code); ?>)</option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            ...
            <div class="row mt-2">
              ...
              <div class="col-sm-9 customer-pan-label"><?php echo e($invoice->customer_pan); ?></div>
              <input type="hidden" name="customer_pan" value="<?php echo e($invoice->customer_pan); ?>"  class="customer_pan" readonly="true">
            </div>
            <?php endif; ?>
            <div class="row mt-2">
              <div class="col-sm-3">GSTIN</div>
              <div class="col-sm-9 customer-gstin-label"><?php echo e($invoice->customer_gstno); ?></div>
              <input type="hidden" name="customer_gstno" value="<?php echo e($invoice->customer_gstno); ?>"  class="customer_gstno" readonly="true">
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="controls mt-2">
                  <label><input type="checkbox" name="is_same_shipping" value="1"  id="is_same_shipping_invoice" <?php echo e($invoice->is_same_shipping == 'yes'? 'checked': ''); ?>> Use
                    Same Shipping Address</label>
                </div>
              </div>
            </div>
            <div id="shipping_detail_drawer" class="<?php echo e($invoice->is_same_shipping == 'yes' ? 'd-none' : ''); ?>">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="" class="control-label ">SHIP. NAME</label>
                    <div class="controls ">
                      <input type="text" value="<?php echo e($invoice->shipping_name); ?>" class="form-control" name="shippingName" id="shippingName"
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls ">
                      <textarea name="shippingAddress" id="shippingAddress" rows="3" cols="2"
                        placeholder="Enter Shipping Address" maxlength="500" class="form-control shippingAddress"><?php echo e($invoice->shipping_address); ?></textarea>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="controls ">
                      <input type="text" value="<?php echo e($invoice->shipping_phone); ?>" name="shippingPhone" id="shippingPhone"
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls ">
                      <select type="list" data- name="shippingState" class="form-control shippingState" id="shippingState">
                        <option >Select State</option>
                        <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($state->id); ?>" <?php echo e($invoice->shipping_state == $state->id ? 'selected' : ''); ?> ><?php echo e($state->name); ?> (<?php echo e($state->state_code); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="shippingCountry" value="<?php echo e($invoice->shipping_country); ?>" id="shippingCountry" class="form-control shippingCountry" placeholder="Enter Country">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="controls ">
                      <input type="text"  name="shippingGSTIN" value="<?php echo e($invoice->shipping_gstin); ?>" id="shippingGSTIN" placeholder="Enter Shipping GSTIN" class="form-control shippingGSTIN" maxlength="30">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="controls ">
                      <input type="text"  name="shippingpan" value="<?php echo e($invoice->shippingpan); ?>" id="shippingPAN" placeholder="Enter Shipping PAN shippingpan" class="form-control" maxlength="30">
                    </div>
                  </div>
                </div>
                    ...
                    <tr class="product-item-row">
                        ...
                        <td class="discount_field">
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" name="discount[]" style="width:60px" value="<?php echo e($item->discount); ?>" class="form-control disc"  value="0"
                                maxlength="10">
                            </div>
                        ...
                        <td>
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" name="cess[]" value="<?php echo e($item->cess); ?>" style="width:60px" class="form-control cess" placeholder="%">
                            </div>
                            <div class="input-group mt-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">Rs</div>
                                </div>
                                <input type="text" name="cess_amount[]"  style="width:60px" value="<?php echo e($item->cessrate); ?>"  class="form-control cess_amount" placeholder="Rs">
                            </div>
      ...
      <div class="row mx-0  bg-white mt-4">
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/saleinvoice/edit.blade.php ENDPATH**/ ?>