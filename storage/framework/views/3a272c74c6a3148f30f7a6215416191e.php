			...
			<div class="container-fluid">
				<div class="page-title-box d-sm-flex align-items-center justify-content-between">
					...
					<div class="">
						...
						<a href="<?php echo e(url('download-pdf-sale-inward?'.$url)); ?>" class="btn btn-light mr-2">Download PDF</a>
						<a target="_blank" href="<?php echo e(url('print-inward?'.$url.'&download=pdf')); ?>">Print</a>
					</div>
				</div>
			</div>
		</div>
														...
														<tr>
															<td class="org_orgname_logo" data-editor=".org_orgname_logo">
                                                                <div class="invoice-logo">
                                                                    ...
                                                                    <img width="100" src="<?php echo e(asset('public/org_logos/'.$organization->logo_image)); ?>" alt="Invoice logo">
                                                                    <?php endif; ?>
                                                                </div>
                                                            </td>
														</tr>
													...
													<tbody>
														<tr>
															<td class="contact_details" data-editor=".contact_details">
																<b>Name</b> :<?php echo e($user_details->name); ?> </td>
														</tr>
														<tr>
															<td class="contact_details">
																<b data-editor=".contact_details b">Phone</b> :<?php echo e($user_details->phone); ?>
																		...
																		<tr>
																			<td style="width: 35%;" class="gstin"
																				data-editor=".gstin"><span style="">PAN
																					:</span><?php echo e($organization->gstin); ?> </td>
																	...
																	<tbody>
																		...
																		<tr>
																			<td class="customerdata_item_label"
																				...
																				M/S</td>
																			<td class="special"
																				data-editor=".customerdata td.special"><?php echo e($payment_receipt->name); ?></td>
																		</tr>
																		<tr>
																			<td class="customerdata_item_label">Address</td>
																			<td style="">
																				<div style="overflow: hidden;"><?php echo e($payment_receipt->address); ?>, <?php echo e($payment_receipt->state_name); ?>
																		...
																		<tr>
																			...
																			<td style=""><?php echo e($payment_receipt->phone); ?></td>
																		</tr>
																		<tr>
																			<td class="customerdata_item_label">
																				GSTIN </td>
																			<td style=""><?php echo e($payment_receipt->gstin_pan); ?></td>
																		</tr>
																		<tr>
																			<td class="customerdata_item_label">
																				State </td>
																			<td style=""><?php echo e($payment_receipt->state_name); ?> (<?php echo e($payment_receipt->state_code); ?>)</td>
																		</tr>
																	</tbody>
																</table>
															</td>
																	...
																	<tbody>
																		<tr>
																			...
																			<td class="special"
																				...
																				<td class="invoicedata_item_label"><?php echo e($payment_receipt->receipt_no); ?>
																		...
																		<tr>
																			...
																			<td>&nbsp;</td>
																			<td><?php echo e($payment_receipt->payment_date); ?></td>
																			<td>&nbsp;</td>
																		</tr>
																	</tbody>
																</table>
																	...
																	<tbody>
																		<tr>
																			<td class="txt-bg"
																				...
																				Total Amount</td>
																			<td class="txt-bg txt-right"><?php echo e($payment_receipt->amount); ?></td>
																		</tr>
																		<tr>
...
<script>
$(".amount_in_words").text(number2text(<?php echo e($payment_receipt->amount); ?>));
</script>

<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/saleinvoicereceipt/print.blade.php ENDPATH**/ ?>