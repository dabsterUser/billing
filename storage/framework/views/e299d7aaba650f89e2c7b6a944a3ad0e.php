...
Dear <?php echo e($userDetail->name); ?>,
<p>
Hey<br/>

Thanks for signing up to Epiliam! <br/>
To activate your account please verify your email address:<br/>
</p>
<p>You can click on this link : <a href="<?php echo e(url('/verify_otp/'.$userDetail->encrypted.'/'.$userDetail->otp)); ?>">Click to verify</a></p>
<p>
OTP : <b><?php echo e($userDetail->otp); ?></b><br/>
</p>
<p>Note: OTP or Link Will be expire in 24 hours</p>
</div>
</td>
</tr>
<tr>
...
<?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/emails/verification.blade.php ENDPATH**/ ?>