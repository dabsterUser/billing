      ...
      <div class="row justify-content-center">
        ...
        <div class="col-7 bg-white d-flex align-items-center min-vh-100 px-5">
            <div class="register-body">
              ...
              <form method="POST" id="user-register-form" action="<?php echo e(route('register')); ?>">
              <?php echo csrf_field(); ?>
                <div class="row">
...
unset($__errorArgs, $__bag); ?>"  placeholder="Full Name" name="name" value="<?php echo e(old('name')); ?>"  autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 form-group">
                      <label for="" class=""><?php echo e(__('Email address')); ?></label>
                      <div class="controls">
...
unset($__errorArgs, $__bag); ?>" placeholder="@example.com" name="email" value="<?php echo e(old('email')); ?>"  autocomplete="email">
...
unset($__errorArgs, $__bag); ?>"  placeholder="OTP will send on this number" name="phone" id="phone" value="<?php echo e(old('phone')); ?>"  autocomplete="phone">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="controls">
                        <label class="<?php $__errorArgs = ['term_condition'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><input type="checkbox" name="term_condition" <?php echo e(old('term_condition') == 'accepted' ?'checked':''); ?> value="accepted" id="" > I agree to <a href="#"> Terms & condition</a> and <a href="#"> Privacy policy</a>  </label>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/auth/register.blade.php ENDPATH**/ ?>