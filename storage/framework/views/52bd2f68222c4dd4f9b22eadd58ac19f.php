...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="<?php echo e(url('/dashboard')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('new/images/logo-sm.png')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('new/images/logo-dark.png')); ?>" alt="" height="21">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="<?php echo e(url('/dashboard')); ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('images/logo-sm.png')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('new/images/logo-light.png')); ?>" alt="" height="21">
                    </span>
                </a>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <div class="help-box text-center">
                            <img src="<?php echo e(asset('new/images/create-invoice.png')); ?>" class="img-fluid" alt="">
        ...
        <?php /**PATH C:\xampp\htdocs\billing\resources\views/partials/customer/sidebar.blade.php ENDPATH**/ ?>