            ...
            <div class="row mx-0">
                <div class="col-6 py-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea  class="form-control" name="address1" id="address1"   placeholder="Full address" rows="4"><?php echo e($organization->address1); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-6 bg-grey py-3">
                    ...
                    <div class="form-group mt-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="bank_upi" id="bank_upi" class="form-control"  aria-describedby="" value="<?php echo e(isset($banks[0]) ? $banks[0]->bank_upi : ''); ?>" placeholder="Your UPI ID (If any)">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Work\NewBilling\resources\views/setting/business_detail.blade.php ENDPATH**/ ?>