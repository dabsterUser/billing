              ...
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  ...
                  <div class="page-title-right">
                      <ol class="breadcrumb m-0">
                          <li class="breadcrumb-item"><a href="<?php echo e(url('/purchase-receipt')); ?>">Outward Payment</a></li>
            ...
            <?php echo e(method_field('PATCH')); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 form-controls mt-3 text-end">
                    <a type="button" class="btn btn-outline-danger mx-1" href="<?php echo e(url('purchase-receipt')); ?>">Cancel</a>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/purchaseinvoicereceipt/edit.blade.php ENDPATH**/ ?>