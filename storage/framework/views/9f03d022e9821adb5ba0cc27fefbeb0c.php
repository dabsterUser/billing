  ...
  <div class="container-fluid">
    <div class="row d-flex justify-content-end align-items-center">
      ...
      <div class="col-8 text-right">
        <a href="<?php echo e(url('/sale-invoice/create')); ?>" class="btn btn-primary mr-2">Add</a>
        ...
        <table class="table table-border table-hover" data-footable="" id="sale-invoice-datatable"
          ...
          <tbody>
            ...
            <tr class="table-bill-detail-rows">
              ...
              <td><a href="<?php echo e(url('/sale-invoice/'.$invoice->id.'/edit')); ?>" class="btn btn-outline-primary"><i
                    class="icon icon-pencil"></i>Edit</a></td>
              <td>

                <p><a href="<?php echo e(url('print-invoice')); ?>?id=<?php echo e($invoice->id); ?>" class="btn btn-info print-btn"
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\Work\NewBilling\resources\views/saleinvoice/index.blade.php ENDPATH**/ ?>