...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="<?php echo e(url('/dashboard')); ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('public/new/images/logo-sm.png')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('public/new/images/logo-dark.png')); ?>" alt="" height="21">
                    </span>
                </a>
                <!-- Light Logo-->
                <a href="<?php echo e(url('/dashboard')); ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('public/images/logo-sm.png')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('public/new/images/logo-light.png')); ?>" alt="" height="21">
                    </span>
                </a>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/point-of-sale')); ?>" >
                                <i class="las la-file-invoice"></i> <span data-key="t-invoices">Point of Sales</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/sale-invoice')); ?>" >
                                <i class="las la-file-invoice"></i> <span data-key="t-invoices">Sales</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/purchase-invoice')); ?>" >
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(url('/products')); ?>" >
                                <i class="las la-pen-nib"></i> <span data-key="t-bootstrap-ui">Products/Services</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(url('/transports')); ?>" >
                                <i class="las la-pen-nib"></i> <span data-key="t-bootstrap-ui">Transport</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="<?php echo e(url('/expenses')); ?>" >
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="<?php echo e(url('/sales-report')); ?>" class="nav-link" data-key="t-grid">Sales-Report</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo e(url('/sales-outstandings-report')); ?>" class="nav-link" data-key="t-grid">Sales-Outstandings</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo e(url('/sales-product-report')); ?>" class="nav-link" data-key="t-grid">Sales-Products</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo e(url('/sales-inward-report')); ?>" class="nav-link" data-key="t-grid">Sales-Inward</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="collapse menu-dropdown " id="purchaseReprtsUI">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="<?php echo e(url('/purchase-report')); ?>" class="nav-link" data-key="t-dropdowns">Purchase-Report</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo e(url('/purchase-outstandings-report')); ?>" class="nav-link" data-key="t-grid">Purchase-Outstandings</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo e(url('/purchase-product-report')); ?>" class="nav-link" data-key="t-grid">Purchase-Products</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="<?php echo e(url('/purchase-inward-report')); ?>" class="nav-link" data-key="t-grid">Purchase-Inward</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="help-box text-center">
                            <img src="<?php echo e(asset('public/new/images/create-invoice.png')); ?>" class="img-fluid" alt="">
        ...
        <?php /**PATH /home/u284794662/domains/dabstersofttech.com/public_html/billing/resources/views/partials/customer/sidebar.blade.php ENDPATH**/ ?>