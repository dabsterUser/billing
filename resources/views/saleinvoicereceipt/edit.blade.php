          ...
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              ...
              <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                      <li class="breadcrumb-item"><a href="{{ url('/sale-receipt') }}">Inward Payment</a></li>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="{{ url('/sale-receipt/'.$payment_receipt->id) }}" method="post" id="edit-receipt-form">
              @csrf
            {{ method_field('PATCH')}}
                <div class="row">
                  ...
                  <div class="col-md-6 mt-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <p class="text-capitalize"><b>{{$payment_receipt->gstin_pan}}</b></p>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 mt-2">
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <input type="text" class="form-control mb-2 datepicker" value="{{ \Carbon\Carbon::now()->toDateString($payment_receipt->payment_date,'d-M-Y')}}" name="payment_date">
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 form-controls mt-3 text-end">
                    <a type="button" class="btn btn-outline-danger mx-1" href="{{url('sale-receipt')}}">Cancel</a>
