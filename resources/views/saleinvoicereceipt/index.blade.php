    ...
    <div class="container-fluid">
      ...
      <div class="row pb-4 gy-3">
        <div class="col-sm-4">
            ...
            <a class="btn btn-primary" href="{{url('/sale-receipt/create')}}" ><i class="las la-plus me-1"></i>Add Receipt </a>      
        </div>
            ...
            @if(count($salereceipt)>0)
              @foreach($salereceipt as $receipt)
                <tr>
                  ...
                  <td>
                    <a href="{{url('/sale-receipt/'.$receipt->id.'/edit')}}" class="btn btn-outline-primary"> <i class="las la-pen fs-18 align-middle me-2 text-muted"></i>Edit</a>
                  </td>
                  <td class="footable-last-visible">
                  <p>
                    <a href="{{url('print-inward')}}?id={{$receipt->id}}" class="btn btn-outline-success print-btn" target="_blank" data-link="{{url('print-inward')}}?id={{$receipt->id}}" data-id="{{$receipt->id}}" > <i class="ri-printer-line fs-18 align-middle me-2 text-muted"></i>Print</a></p>
