                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <a href="{{ url('/dashboard') }}" class="btn btn-light mr-2">Cancel</a>
            ...
            <div class="row mx-0">
                <div class="col-6 py-3">
                                ...
                                <div class="position-relative d-flex">
                                    @if ($organization->logo_image)
                                        <div class="logo col-4">
                                            <img src="{{ asset('public/org_logos/'.$organization->logo_image) }}" alt="" width="100">
                                        </div>
                                        <div class="change-logo col-8 w-100">
                                            <input type="file" name="logo_image" class="custom-file-input" id="validatedCustomFile" value="{{ $organization->logo_image }}" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input  class="form-control" name="address1" id="address1"   placeholder="Full address" value="{{$organization->address1}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">Address Line 2</label>
                        <div class="col-sm-9">
                            <input  class="form-control" name="address2" id="address2"   placeholder="Full address" value="{{$organization->address2}}">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-6 bg-grey py-3">
                    ...
                    <div class="form-group mt-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="upi_id" id="bank_upi" class="form-control"  aria-describedby="" value="{{isset($banks[0]) ? $banks[0]->upi_id : ''}}" placeholder="Your UPI ID (If any)">
                        </div>
                    </div>
                </div>
            </div>
