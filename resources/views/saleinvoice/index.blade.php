...
<div class="page-content">
  <div class="container-fluid">
    ...
    <div class="row pb-4 gy-3">
        <div class="col-sm-4">
            <a href="{{ url('sale-invoice/create') }}" class="btn btn-primary addMembers-modal"><i class="las la-plus me-1"></i> Add Invoices</a>
        </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                  <a class="dropdown-item" href="{{ url('sale-invoice/'.$invoice->id.'/edit') }}"><i class="las la-pen fs-18 align-middle me-2 text-muted"></i>
                                                      Edit</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{url('print-invoice')}}?id={{$invoice->id}}"><i class="las la-eye fs-18 align-middle me-2 text-muted"></i>
                                                        View & Print</a>
                                                </li>
                                                {{-- <li>
