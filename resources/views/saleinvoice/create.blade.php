    ...
    <div class="main-form-container  mt-4 mb-4">
                ...
                <div class="col-sm-6">
                  <div class="form-group row">
                    ...
                    <div class="controls col-sm-7">
                      ...
                      @endphp 
                      <input id="invoice_id" name="invoice_number" class="form-control" value="{{ $newInvoiceId }}">
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
          ...
          <table class="table table-bordered addinvoice-table mb-0" id="document-item-list">
            ...
            <tbody class="ui-sortable product-list-row">
              <tr class="product-item-row">
                ...
                {{-- <td>
                  <input type="text" name="gst[]" readonly="false" class="form-control gst" placeholder="%" style="width:50px;"
                    maxlength="5" >
                </td> --}}
      ...
      <div class="row mx-0 mt-4 bg-white">
        <div class="col-sm-6 border-right py-3">
          ...
          <input type="hidden" name="" class="currentUser_stateId" value="{{ $organization->state_id }}">
