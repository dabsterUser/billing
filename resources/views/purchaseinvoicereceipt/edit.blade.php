              ...
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  ...
                  <div class="page-title-right">
                      <ol class="breadcrumb m-0">
                          <li class="breadcrumb-item"><a href="{{ url('/purchase-receipt') }}">Outward Payment</a></li>
            ...
            {{ method_field('PATCH')}}
                <div class="row">
                  ...
                  <div class="col-md-12 form-controls mt-3 text-end">
                    <a type="button" class="btn btn-outline-danger mx-1" href="{{url('purchase-receipt')}}">Cancel</a>
