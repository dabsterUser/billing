        ...
        <div class="container-fluid">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="">
                    ...
                    <a href="{{ url('download-pdf-purchase-inward?'.$url)}}" class="btn btn-light mr-2">Download PDF</a>
                    <a target="_blank" href="{{ url('print-purchase-inward?'.$url.'&download=pdf') }}">Print</a>
                </div>
            </div>
        </div>
    </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="">
                                                                                    <div style="overflow: hidden;">
                                                                                        {{$payment_receipt->address}},
                                                                                        {{$payment_receipt->state_name}}
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="customerdata_item_label">
                                                                                    PHONE</td>
                                                                                <td style="">{{$payment_receipt->phone}}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="customerdata_item_label">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="invoicedata_item_label">
                                                                                    Voucher Date</td>
                                                                                <td>&nbsp;</td>
                                                                                <td>{{$payment_receipt->payment_date}}
                                                                                </td>
                                                                                <td>&nbsp;</td>
                                                                            </tr>
                                                                        </tbody>
