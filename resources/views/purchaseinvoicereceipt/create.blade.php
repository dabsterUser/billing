...
<div class="page-content">
    ...
    <script type="text/javascript" src="{{ asset('public/js/jquery.selectlistactions.js')}}"></script>
    <script type="text/javascript" src="{{ asset('public/js/invoice-receipt.js')}}"></script>
