  ...
  <div class="top-stickybar"> 
    <div class="container-fluid">
      ...
      <div class="row pb-4 gy-3">
        <div class="col-sm-4">
            <a class="btn btn-primary" href="{{url('/purchase-receipt/create')}}" ><i class="las la-plus me-1"></i>Add Receipt </a>      
        </div>
        ...
        <div class="record-table custom-data-table mt-3 mb-3 bg-white py-3 px-3">
                     ...
                     @if(count($salereceipt)>0)
                      @foreach($salereceipt as $receipt)
                        <tr>
                          ...
                          <td>
                            <a href="{{url('/purchase-receipt/'.$receipt->id.'/edit')}}" class="btn btn-outline-primary"><i class="las la-pen fs-18 align-middle me-2 text-muted"></i>Edit</a>
                          </td>
                          <td class="footable-last-visible">
                            <!-- <p><a href="javascript:;" href="" class="btn btn-info">Print</a></p> -->
                            <a href="{{url('print-purchase-inward')}}?id={{$receipt->id}}" class="btn btn-outline-success print-btn" target="_blank" data-link="{{url('print-purchase-inward')}}?id={{$receipt->id}}" data-id="{{$receipt->id}}" ><i class="ri-printer-line fs-18 align-middle me-2 text-muted"></i>Print</a>
              ...
              <div class="card-footer bg-primary">
                <div class="row">
                  ...
                  <div class="col text-right"><a href="{{url('/purchase-receipt/create')}}" class="btn btn-light mr-3"><i class="icon icon-plus"></i>
                      Add New</a>
                   </div>
                </div>
              </div>
