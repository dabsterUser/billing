                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="fs-18 fw-semibold  ff-secondary mb-2">Total </h4>
                                <span class="text-success fs-14 mb-0 ms-1 counter-value" data-target="{{$product_count}}">
          ...
          <table class="table table-hover" data-footable="" id="product-datatable" data-toggle-column="last"
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="{{asset('public/images')}}/{{$product->product_image}}" width="70" height="70"></td>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    {{-- <a href="#" data-toggle="modal" data-target="#updateStock{{$product->id}}"> --}}
                    <a href="#"  data-bs-toggle="modal" class="mx-1" data-bs-target="#updateStock{{$product->id}}">
                      <i class="bx bx-plus-circle" aria-hidden="true"></i>
                    </a>
                  </div>

                  {{-- Modal for Adding Stock --}}
                    <div class="modal fade" id="updateStock{{$product->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('stockUpdate',$product->id)}}" method="post">
                                @csrf
                ...
                <td class="td-actions">
                  <input data-id="{{$product->id}}" class="toggle-class btn btn-outline-success" type="checkbox"
                    ...
                    data-off="InActive" {{ $product->is_visible_all=='1' ? 'checked' : '' }}>
                  </td>

                <td class="td-actions footable-last-visible">
                  {{-- <a href="javascript:;" onclick="get_product_by_id('{{$product->id}}')" class="btn btn-outline-primary">
                    <i class="icon icon-pencil"></i>Edit
                  </a> --}}

                  <a href="#EditProductoffcanvas" data-bs-toggle="offcanvas" role="button" aria-controls="EditProductoffcanvas" onclick="get_product_by_id('{{$product->id}}')" class="btn btn-outline-primary d-flex" >
                  ...
                  <div class="offcanvas offcanvas-end Productroffcanvas" tabindex="-1" id="EditProductoffcanvas" aria-labelledby="EditProductoffcanvasLabel">
                    ...
                    <div class="offcanvas-body">
                      <div class="modal-content">
                        <form method="post" action="{{route('products.update',$product->id)}}" id="update-product-form"  enctype="multipart/form-data">
                                  @csrf
                            {{ method_field('PATCH') }}
  
                          <input type="hidden" name="update_productId" id="update_productId" value="{{$product->id}}">
