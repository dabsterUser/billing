        ...
        <div class="main-form-container mt-4 bg-white">
            <div class="container">
                ...
                <div class="form_body mt-4 px-2 py-4">
                    <form action="{{ url('/purchase-outstandings-invoice') }}" id="sale_form">
                        @csrf
                        <div class="row">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body p-0">
                                                ...
                                                <table class="table table-hover table-nowrap align-middle mb-0">
                                                    ...
                                                    <tbody>
                                                        @php
                                                            ...
                                                            $grandtotal = 0;
                                                        @endphp
                                                        @foreach ($purchaseOutstandings as $outstandings)
                                                        <tr>
                                                            <td></td>
                            ...
                            <div class="d-flex justify-content-end py-4 gap-2 ">
                                ...
                                <a href="{{ url('/export-purchase-outstandings-report') }}" class="btn btn-success mr-4">Export</a>
