    ...
    <table id="Record" class="table" style="margin-top: 20px;">
        ...
        <tbody>
            @php
                ...
                $grandtotal = 0;
            @endphp
            @foreach ($purchaseOutstandings as $data)
                <tr>
                    <td colspan="2">{{ $data->bill_date }}</td>
                    <td colspan="2">{{ "Company Name" }}</td>
                    <td colspan="2">{{ $data->invoice_number }}</td>
                    <td colspan="2">{{ $data->item_total }}</td>
                    <td colspan="2">{{ number_format($data->item_total - $data->payment_received, 2, '.', '') }}
                    <td colspan="2">{{ "15 days" }}
                    </tr>
                @php
