    ...
    <div class="main-form-container">
        <div class="container">
            ...
            <div class="form_body mt-5">
                <form action="{{ url('/daily-expenses-report-invoice') }}" >
                    @csrf
                    <div class="row">
                        <div class="form_filed mb-4 col-3">
                            <label for="name-f">Title:</label>
                            <input type="text" class="form-control" name="expense-title" id="expense_title"  >
                        </div>
                ...
                <div class="card border-0">
                    <div class="card-header bg-white border-0">
                        ...
                        <div class="sale_register d-flex justify-content-center flex-column align-items-center">
                            <h4 class="sale_info text-capitalize">Daily Expense Report</h4>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @foreach($expenses as $expense)
                                        <tr>
                                            <td class=" text-capitalize"> {{ $expense->title }}</td>
