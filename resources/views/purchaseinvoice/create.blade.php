...
@section('content')
<form action="{{url('/purchase-invoice')}}" method="post" id="add-saleinvoice-form">
    ...
    <div class="container-fluid">
      <div class="row d-flex justify-content-end align-items-center">
        ...
        <div class="col-8 d-flex justify-content-end">
          <a href="{{url('/purchase-invoice')}}" class="btn btn-light mr-2">Cancel</a>
...
<script src="{{asset('public/js/purcahse-customer.js')}}"></script>
