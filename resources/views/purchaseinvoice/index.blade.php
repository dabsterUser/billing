...
<div class="page-content">
  <div class="container-fluid">
    ...
    <div class="row pb-4 gy-3">
        <div class="col-sm-4">
            <a href="{{ url('purchase-invoice/create') }}" class="btn btn-primary addMembers-modal"><i class="las la-plus me-1"></i> Add Invoices</a>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">Rs.<span class="counter-value" data-target="{{ $till_date_total }}">0</span></h4>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">Rs.<span class="counter-value" data-target="{{$month_total}}">0</span></h4>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2 text-white">Rs.<span class="counter-value" data-target="{{ $today_total }}">0</span></h4>
                            ...
                            <tbody>
                              @if(count($invoices) > 0)
                                ...
                                <tr>
                                    ...
                                    <td><p class="fw-medium mb-0">{{$invoice->invoice_number}}</p></td>
                                    <td> 
                                      <div class="col-xl-3 col-lg-4 col-sm-6">
                                        {{-- <i class="bx bx-user-circle"></i> --}}
                                        <a href="" class="text-body align-middle fw-medium">{{$invoice->customer_name}}</a>
                                      </div>
                                    ...
                                    <td>
                                      ...
                                      @elseif($invoice->payment_type == 'cheque')
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item" href="{{url('print-invoice-purchase')}}?id={{$invoice->id}}"><i class="las la-eye fs-18 align-middle me-2 text-muted"></i>
                                                        View & Print</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="{{url('purchase-invoice/'.$invoice->id.'/edit')}}"><i class="las la-pen fs-18 align-middle me-2 text-muted"></i>
                                                        Edit</a>
                                                </li>
                                                <li>
...
<script>
  ...
  var product_datatable = $('#purchase-invoice-datatable').DataTable();
