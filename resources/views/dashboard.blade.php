                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2"><span class="counter-value" data-target="{{ $total_customer }}">0</span></h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            ?>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">Rs.<span class="counter-value" data-target="{{ $totalsale }}">0</span></h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            ?>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-2">Rs.<span class="counter-value" data-target="{{ $totalpurchase }}">0</span></h4>
                              ...
                              <tbody>
                                @foreach($saleinvoice as $saleinvoices)
                                  <tr>
                                      ...
                                      <td><p class="mb-0">{{$saleinvoices->id}}</p></td>
                                      <td>
                                          <a href="#javascript: void(0);" class="text-body align-middle">{{$saleinvoices->customer_name}}</a>
                                      </td>
                                      <td>{{$saleinvoices->bill_date}}</td>
                                      <td>
                                        {{ number_format($saleinvoices->grand_total - $saleinvoices->payment_received, 2, '.','') }}
                                      </td>
                              ...
                              <tbody>
                                @foreach($purchaseinvoice as $purchaseinvoicecs)
                                  <tr>
                                      ...
                                      <td><p class="mb-0">{{$purchaseinvoicecs->id}}</p></td>
                                      <td>
                                          <a href="#javascript: void(0);" class="text-body align-middle">{{$purchaseinvoicecs->customer_name}}</a>
                                      </td>
