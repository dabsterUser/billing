<div class="customizer-setting d-none d-md-block">
    ...
    <script type="text/javascript" src="{{ asset('js/cdnjs/popper.min.js')}}"></script>
  
  
    <script type="text/javascript" src="{{ asset('js/cdnjs/bootstrap.min.js')}}"></script>
    ...
    {{-- new updated dashboard asset --}}
  
        <!-- JAVASCRIPT -->
        
        <script src="{{ asset('new/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
        <script src="{{ asset('new/libs/simplebar/simplebar.min.js') }}"></script>
        <script src="{{ asset('new/libs/node-waves/waves.min.js') }}"></script>
        <script src="{{ asset('new/libs/feather-icons/feather.min.js') }}"></script>
        <script src="{{ asset('new/js/plugins.js') }}"></script>
  
        <!-- apexcharts -->
        <script src="{{ asset('new/libs/apexcharts/apexcharts.min.js') }}"></script>
  
        <!-- Vector map-->
        <script src="{{ asset('new/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
        <script src="{{ asset('new/libs/jsvectormap/maps/world-merc.js') }}"></script>
  
        <!-- Dashboard init -->
        <script src="{{ asset('new/js/pages/dashboard.init.js') }}"></script>
